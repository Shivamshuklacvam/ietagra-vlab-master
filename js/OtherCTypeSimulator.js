import { simData1} from "./Othersimulators.js";

let CprgCardContainer = document.getElementById("CprgCardContainer");
...
simData1?.map((el) => {
  ...
  card_link.appendChild(document.createTextNode("View Project"));
  ...
  CprgCardContainer?.appendChild(card);
